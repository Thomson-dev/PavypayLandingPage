...
const Payments = () => {
  return (
    <section>
      <div className="container mt-10 md:p-10 pb-10 px-5 flex md:flex-row flex-col  mx-auto">
        {/* Image */}
          ...
          <div className="flex flex-col  space-y-4">
            ...
            <div className="flex flex-col space-y-3 md:flex-row items-center">
              ...
              <div className="flex md:px-10 flex-col space-y-2 ">
                <div className="flex flex-row items-center">
                  <div className="w-[1px] h-4 bg-blue-700"></div>
                  <h3 className="text-lg px-3 font-semibold">Transparency</h3>
                </div>
                <p className="text-lg text-textColor">
                  Full visibility of funds, you know where your money is at all
                  times
                </p>
              </div>
            </div>
